...
EFI_GUID mAppleSmcIoProtocolGuid            = {0x17407E5A, 0xAF6C, 0x4EE8, {0x98, 0xA8, 0x00, 0x21, 0x04, 0x53, 0xCD, 0xD9}};
...
MAP_EFI_GUID_STR EfiGuidStrMap[] = {
  ...
  {&mEfiAppleBootGuid, L"gAppleBootVariableGuid"},
  {&mEfiAppleNvramGuid, L"gAppleVendorVariableGuid"},
  ...
  {&mAppleSmcIoProtocolGuid, L"gAppleSmcIoProtocolGuid"},

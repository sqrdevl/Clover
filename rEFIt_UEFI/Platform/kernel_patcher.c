...
//  EFI_STATUS      Status;
  ...
  /*Status = */gRT->GetVariable(L"OsxAptioFixDrv-RelocBase", &gAppleBootVariableGuid, NULL, &DataSize, &KernelRelocBase);
  DeleteNvramVariable(L"OsxAptioFixDrv-RelocBase", &gAppleBootVariableGuid); // clean up the temporary variable

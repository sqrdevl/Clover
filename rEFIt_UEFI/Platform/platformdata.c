...
{
  //MacBook1,1
  { "MacBook1,1", "MB11.88Z.0061.B03.0610121324", "Mac-F4208CC8", // Intel Core Duo T2500 @ 2.00 GHz
    "MacBook", "1.1", "W80A041AU9B", "MacBook-White",
    { 0x01, 0x04, 0x0f, 0, 0, 0x12 },  "branch", "m70", 0x71001 },
  //MacBook2,1
  { "MacBook2,1", "MB21.88Z.00A5.B07.0706270922", "Mac-F4208CA9", // Intel Core 2 Duo T7200 @ 2.00 GHz
    "MacBook", "1.2", "W88A041AWGP", "MacBook-White",
    { 0x01, 0x13, 0x0f, 0, 0, 0x03 },  "branch", "m75", 0x72001 },
  //MacBook3,1
  { "MacBook3,1", "MB31.88Z.008E.B02.0803051832", "Mac-F22788C8", // Intel Core 2 Duo T7500 @ 2.20 GHz
    "MacBook", "1.3", "W8803HACY51", "MacBook-White",
    { 0x01, 0x24, 0x0f, 0, 0, 0x03 },  "branch", "k36", 0x72001 }, // need ECPI
  //MacBook4,1
  { "MacBook4,1", "MB41.88Z.00C1.B00.0802091535", "Mac-F22788A9", // Intel Core 2 Duo T8300 @ 2.39 GHz
    "MacBook", "1.3", "W88A041A0P0", "MacBook-Black",
    { 0x01, 0x31, 0x0f, 0, 0, 0x01 },  "branch", "m82", 0x74001 },
  //MacBook5,1
  { "MacBook5,1", "MB51.88Z.007D.B03.0904271443", "Mac-F42D89C8", // Intel Core 2 Duo P7350 @ 2.00 GHz
    "MacBook", "1.3", "W8944T1S1AQ", "MacBook-Black",
    { 0x01, 0x32, 0x0f, 0, 0, 0x08 },  "branch", "m97", 0x7a002 }, // need ECPI
  //MacBook5,2
  { "MacBook5,2", "MB52.88Z.0088.B05.0904162222", "Mac-F22788AA", // Intel Core 2 Duo P7450 @ 2.13 GHz
    "MacBook", "1.3", "W88AAAAA9GU", "MacBook-Black",
    { 0x01, 0x38, 0x0f, 0, 0, 0x05 },  "branch", "k36b", 0x7a002 },
  //MacBook6,1
  { "MacBook6,1", "MB61.88Z.00CB.B00.1708080203", "Mac-F22C8AC8", // Intel Core 2 Duo P7550 @ 2.26 GHz
    "MacBook", "1.0", "451131JCGAY", "MacBook-White",
    { 0x01, 0x51, 0x0f, 0, 0, 0x53 },  "NA", "NA", 0x7a002 }, // need rBR RPlt ECPI
  //MacBook7,1
  { "MacBook7,1", "MB71.88Z.003D.B00.1708080317", "Mac-F22C89C8", // Intel Core 2 Duo P8600 @ 2.40 GHz
    "MacBook", "1.0", "451211MEF5X", "MacBook-White",
    { 0x01, 0x60, 0x0f, 0, 0, 0x06 },  "k87", "k87", 0x7a002 }, // need ECPI
  //MacBook8,1
  { "MacBook8,1", "MB81.88Z.0168.B00.1708080033", "Mac-BE0E8AC46FE800CC", // Intel Core M-5Y51 @ 1.20 GHz
  ...
  //MacBookPro1,1
  { "MacBookPro1,1", "MBP11.88Z.0055.B08.0610121325", "Mac-F425BEC8", // Intel Core Duo T2500 @ 2.00 GHz
    "MacBook Pro", "1.0", "W884857JVJ1", "MacBook-Aluminum",
    { 0x01, 0x02, 0x0f, 0, 0, 0x10 },  "m1", "m1", 0x7b002 }, // need ECPI
  //MacBookPro1,2
  { "MacBookPro1,2", "MBP12.88Z.0061.B03.0610121334", "Mac-F42DBEC8", // Intel Core Duo T2600 @ 2.17 GHz
    "MacBook Pro", "1.0", "W8629HACTHY", "MacBook-Aluminum",
    { 0x01, 0x05, 0x0f, 0, 0, 0x10 },  "NA", "NA", 0x7b002 }, // need rBR RPlt ECPI
  //MacBookPro2,1
  { "MacBookPro2,1", "MBP21.88Z.00A5.B08.0708131242", "Mac-F42189C8", // Intel Core 2 Duo T7600 @ 2.33 GHz
    "MacBook Pro", "1.0", "W88130WUW0H", "MacBook-Aluminum",
    { 0x01, 0x14, 0x0f, 0, 0, 0x05 },  "NA", "NA", 0x7b002 }, // need rBR RPlt ECPI
  //MacBookPro2,2
  { "MacBookPro2,2", "MBP22.88Z.00A5.B07.0708131242", "Mac-F42187C8", // Intel Core 2 Duo T7400 @ 2.16 GHz
    "MacBook Pro", "1.0", "W8827B4CW0L", "MacBook-Aluminum",
    { 0x01, 0x13, 0x0f, 0, 0, 0x03 },  "NA", "NA", 0x7b002 }, // need rBR RPlt ECPI
  //MacBookPro3,1
  { "MacBookPro3,1", "MBP31.88Z.0070.B07.0803051658", "Mac-F4238BC8", // Intel Core 2 Duo T7700 @ 2.40 GHz
    "MacBook Pro", "1.0", "W8841OHZX91", "MacBook-Aluminum",
    { 0x01, 0x16, 0x0f, 0, 0, 0x11 },  "NA", "NA", 0x7b002 }, // need rBR RPlt ECPI
  //MacBookPro4,1
  { "MacBookPro4,1", "MBP41.88Z.00C1.B03.0802271651", "Mac-F42C89C8", // Intel Core 2 Duo T8300 @ 2.40 GHz
    "MacBook Pro", "1.0", "W88484F2YP4", "MacBook-Aluminum",
    { 0x01, 0x27, 0x0f, 0, 0, 0x03 },  "m87", "m87", 0x7b002 }, // need ECPI
  //MacBookPro5,1
  { "MacBookPro5,1", "MBP51.88Z.007E.B06.1202061253", "Mac-F42D86C8", // Intel Core 2 Duo P8600 @ 2.40 GHz
    "MacBook Pro", "1.0", "W88439FE1G0", "MacBook-Aluminum",
    { 0x01, 0x33, 0x0f, 0, 0, 0x08 },  "m98", "m98", 0x7b002 },
  //MacBookPro5,2
  { "MacBookPro5,2", "MBP52.88Z.008E.B05.0905042202", "Mac-F2268EC8", // Intel Core 2 Duo T9600 @ 2.80 GHz
    "MacBook Pro", "1.0", "W8908HAC2QP", "MacBook-Aluminum",
    { 0x01, 0x42, 0x0f, 0, 0, 0x04 },  "NA", "NA", 0x7b002 }, // need rBR RPlt ECPI
  //MacBookPro5,3
  { "MacBookPro5,3", "MBP53.88Z.00AC.B03.0906151647", "Mac-F22587C8", // Intel Core 2 Duo P8800 @ 2.66 GHz
    "MacBook Pro", "1.0", "W8035TG97XK", "MacBook-Aluminum",
    { 0x01, 0x48, 0x0f, 0, 0, 0x02 },  "NA", "NA", 0x7b002 }, // need rBR RPlt ECPI
  //MacBookPro5,4
  { "MacBookPro5,4", "MBP53.88Z.00AC.B03.0906151647", "Mac-F22587A1", // Intel Core 2 Duo P8700 @ 2.53 GHz
    "MacBook Pro", "1.0", "W8948HAC7XJ", "MacBook-Aluminum",
    { 0x01, 0x49, 0x0f, 0, 0, 0x02 },  "NA", "NA", 0x7b002 }, // need rBR RPlt ECPI
  //MacBookPro5,5
  { "MacBookPro5,5", "MBP55.88Z.00AC.B03.0906151708", "Mac-F2268AC8", // Intel Core 2 Duo P7550 @ 2.26 GHz
    "MacBook Pro", "1.0", "W8035TG966D", "MacBook-Aluminum",
    { 0x01, 0x47, 0x0f, 0, 0, 0x02 },  "NA", "NA", 0x7b002 }, // need rBR RPlt ECPI
  //MacBookPro6,1
  { "MacBookPro6,1", "MBP61.88Z.005A.B00.1708072217", "Mac-F22589C8", // Intel Core i5-540M @ 2.53 GHz
    "MacBook Pro", "1.0", "C02G5834DC79", "MacBook-Aluminum",
    { 0x01, 0x57, 0x0f, 0, 0, 0x18 },  "k17", "k17", 0x7a004 }, // need ECPI
  //MacBookPro6,2
  { "MacBookPro6,2", "MBP61.88Z.005A.B00.1708072217", "Mac-F22586C8", // Intel Core i7-620M @ 2.66 GHz
    "MacBook Pro", "1.0", "CK132A91AGW", "MacBook-Aluminum",
    { 0x01, 0x58, 0x0f, 0, 0, 0x17 },  "k74", "k74", 0x7a004 },
  //MacBookPro7,1
  { "MacBookPro7,1", "MBP71.88Z.003D.B00.1708080058", "Mac-F222BEC8", // Intel Core 2 Duo P8600 @ 2.40 GHz
    "MacBook Pro", "1.0", "CK145C7NATM", "MacBook-Aluminum",
    { 0x01, 0x62, 0x0f, 0, 0, 0x07 },  "branch", "k6", 0x7a004 }, // need ECPI
  //MacBookPro8,1
  { "MacBookPro8,1", "MBP81.88Z.004D.B00.1708080655", "Mac-94245B3640C91C81", // Intel Core i5-2415M @ 2.30 GHz
    "MacBook Pro", "1.0", "W89F9196DH2G", "MacBook-Aluminum",
    { 0x01, 0x68, 0x0f, 0, 0, 0x99 },  "k90i", "k90i", 0x7b005 },
  //MacBookPro8,2
  { "MacBookPro8,2", "MBP81.88Z.004D.B00.1708080655", "Mac-94245A3940C91C80", // Intel Core i7-2675QM @ 2.20 GHz
    "MacBook Pro", "1.0", "C02HL0FGDF8X", "MacBook-Aluminum",
    { 0x01, 0x69, 0x0f, 0, 0, 0x04 },  "trunk", "k91f", 0x7b005 }, // need ECPI
  //MacBookPro8,3
  { "MacBookPro8,3", "MBP81.88Z.004D.B00.1708080655", "Mac-942459F5819B171B", // Intel Core i7-2860QM @ 2.49 GHz
    "MacBook Pro", "1.0", "W88F9CDEDF93", "MacBook-Aluminum",
    { 0x01, 0x70, 0x0f, 0, 0, 0x06 },  "k92", "k92", 0x7c005 },
  //MacBookPro9,1
  { "MacBookPro9,1", "MBP91.88Z.00D7.B00.1708080744", "Mac-4B7AC7E43945597E", // Intel Core i7-3720QM @ 2.60 GHz
    "MacBook Pro", "1.0", "C02LW984F1G4", "MacBook-Aluminum",
    { 0x02, 0x01, 0x0f, 0, 1, 0x75 },  "j31", "j31", 0x76006 }, // need ECPI
  //MacBookPro9,2
  { "MacBookPro9,2", "MBP91.88Z.00D7.B00.1708080744", "Mac-6F01561E16C75D06", // Intel Core i5-3210M @ 2.50 GHz
    "MacBook Pro", "1.0", "C02HA041DTY3", "MacBook-Aluminum",
    { 0x02, 0x02, 0x0f, 0, 0, 0x44 },  "branch", "j30", 0x76006 },
  //MacBookPro10,1
  { "MacBookPro10,1", "MBP101.88Z.00F2.B00.1708080809", "Mac-C3EC7CD22292981F", // Intel Core i7-3740QM @ 2.70 GHz
    "MacBook Pro", "1.0", "C02K2HACDKQ1", "MacBook-Aluminum",
    { 0x02, 0x03, 0x0f, 0, 0, 0x36 },  "d2", "d2", 0x74006 },
  //MacBookPro10,2
  { "MacBookPro10,2", "MBP102.88Z.010B.B00.1708080805", "Mac-AFD8A9D944EA4843", // Intel Core i5-3230M @ 2.60 GHz
    "MacBook Pro", "1.0", "C02K2HACG4N7", "MacBook-Aluminum",
    { 0x02, 0x06, 0x0f, 0, 0, 0x59 },  "branch", "d1", 0x73007 },
  //MacBookPro11,1
  { "MacBookPro11,1", "MBP111.88Z.0142.B00.1708080655", "Mac-189A3D4F975D5FFC", // Intel Core i7-4558U @ 2.80 GHz
    "MacBook Pro", "1.0", "C02LSHACFH00", "MacBook-Aluminum",
    { 0x02, 0x16, 0x0f, 0, 0, 0x68 },  "j44", "j44", 0xf0b007 },
  //MacBookPro11,2
  { "MacBookPro11,2", "MBP112.88Z.0142.B00.1708080655", "Mac-3CBD00234E554E41", // Intel Core i7-4750HQ @ 2.00 GHz
    "MacBook Pro", "1.0", "C02LSHACG86R", "MacBook-Aluminum",
    { 0x02, 0x18, 0x0f, 0, 0, 0x15 },  "j45", "j45", 0xf0b007 }, // need ECPI
  //MacBookPro11,3
  { "MacBookPro11,3", "MBP112.88Z.0142.B00.1708080655", "Mac-2BD1B31983FE1663", // Intel Core i7-4870HQ @ 2.50 GHz
    "MacBook Pro", "1.0", "C02LSHACFR1M", "MacBook-Aluminum",
    { 0x02, 0x19, 0x0f, 0, 0, 0x12 },  "j45g", "j45g", 0xf0d007 },
  //MacBookPro11,4
  { "MacBookPro11,4", "MBP114.88Z.0177.B00.1708080033", "Mac-06F11FD93F0323C5", // Intel Core i7-4770HQ @ 2.20 GHz
    "MacBook Pro", "1.0", "C02SNHACG8WN", "MacBook-Aluminum",
    { 0x02, 0x29, 0x0f, 0, 0, 0x23 },  "NA", "NA", 0xf0b007 }, // need rBR RPlt ECPI
  //MacBookPro11,5
  { "MacBookPro11,5", "MBP114.88Z.0177.B00.1708080033", "Mac-06F11F11946D27C5", // Intel Core i7-4870HQ @ 2.50 GHz
    "MacBook Pro", "1.0", "C02LSHACG85Y", "MacBook-Aluminum",
    { 0x02, 0x30, 0x0f, 0, 0, 0x02 },  "NA", "NA", 0xf0b007 }, // need rBR RPlt ECPI
  //MacBookPro12,1
  { "MacBookPro12,1", "MBP121.88Z.0171.B00.1708080033", "Mac-E43C1C25D4880AD6", // Intel Core i5-5257U @ 2.70 GHz
  ...
  //MacBookAir2,1
  { "MacBookAir2,1", "MBA21.88Z.0075.B05.1003051506", "Mac-F42D88C8", // Intel Core 2 Duo L9600 @ 2.13 GHz
    "MacBook Air", "1.0", "W86494769A7", "Air-Enclosure",
    { 0x01, 0x34, 0x0f, 0, 0, 0x08 },  "NA", "NA", 0x76005 }, // need rBR RPlt ECPI
  //MacBookAir3,1
  { "MacBookAir3,1", "MBA31.88Z.0067.B00.1708080355", "Mac-942452F5819B1C1B", // Intel Core 2 Duo U9400 @ 1.40 GHz
    "MacBook Air", "1.0", "C02FLHACD0QX", "Air-Enclosure",
    { 0x01, 0x67, 0x0f, 0, 0, 0x10 },  "k16k99", "k99", 0x76005 },
  //MacBookAir3,2
  { "MacBookAir3,2", "MBA31.88Z.0067.B00.1708080355", "Mac-942C5DF58193131B", // Intel Core 2 Duo L9600 @ 2.13 GHz
    "MacBook Air", "1.0", "C02DRHACDDR3", "Air-Enclosure",
    { 0x01, 0x66, 0x0f, 0, 0, 0x61 },  "NA", "NA", 0x76005 }, // need rBR RPlt ECPI
  //MacBookAir4,1
  { "MacBookAir4,1", "MBA41.88Z.007B.B00.1708072159", "Mac-C08A6BB70A942AC2", // Intel Core i7-2677M @ 1.80 GHz
    "MacBook Air", "1.0", "C02KGHACDRV9", "Air-Enclosure",
    { 0x01, 0x74, 0x0f, 0, 0, 0x04 },  "k21k78", "k78", 0x76005 }, // need ECPI
  //MacBookAir4,2
  { "MacBookAir4,2", "MBA41.88Z.007B.B00.1708072159", "Mac-742912EFDBEE19B3", // Intel Core i5-2557M @ 1.70 GHz
    "MacBook Air", "1.0", "C02GLHACDJWT", "Air-Enclosure",
    { 0x01, 0x73, 0x0f, 0, 0, 0x66 },  "k21k78", "k21", 0x76005 }, // need ECPI
  //MacBookAir5,1
  { "MacBookAir5,1", "MBA51.88Z.00F4.B00.1708080803", "Mac-66F35F19FE2A0D05", // Intel Core i7-3667U @ 2.00 GHz
    "MacBook Air", "1.0", "C02J6HACDRV6", "Air-Enclosure",
    { 0x02, 0x04, 0x0f, 0, 0, 0x19 },  "j11j13", "j11", 0x7b006 }, // need ECPI
  //MacBookAir5,2
  { "MacBookAir5,2", "MBA51.88Z.00F4.B00.1708080803", "Mac-2E6FAB96566FE58C", // Intel Core i5-3427U @ 1.80 GHz
    "MacBook Air", "1.0", "C02HA041DRVC", "Air-Enclosure",
    { 0x02, 0x05, 0x0f, 0, 0, 0x09 },  "j11j13", "j13", 0x7b006 },
  //MacBookAir6,1
  { "MacBookAir6,1", "MBA61.88Z.0103.B00.1708080653", "Mac-35C1E88140C3E6CF", // Intel Core i7-4650U @ 1.70 GHz
    "MacBook Air", "1.0", "C02KTHACF5NT", "Air-Enclosure",
    { 0x02, 0x12, 0x0f, 0, 1, 0x43 },  "j41j43", "j41", 0x7b007 }, // need ECPI
  //MacBookAir6,2
  { "MacBookAir6,2", "MBA61.88Z.0103.B00.1708080653", "Mac-7DF21CB3ED6977E5", // Intel Core i5-4250U @ 1.30 GHz
    "MacBook Air", "1.0", "C02HACKUF5V7", "Air-Enclosure",
    { 0x02, 0x13, 0x0f, 0, 0, 0x15 },  "j41j43", "j43", 0x7b007 },
  //MacBookAir7,1
  { "MacBookAir7,1", "MBA71.88Z.0171.B00.1708072210", "Mac-9F18E312C5C2BF0B", // Intel Core i5-5250U @ 1.60 GHz
    "MacBook Air", "1.0", "C02PCLGFH569", "Air-Enclosure",
    { 0x02, 0x26, 0x0f, 0, 0, 0x02 },  "j110", "j110", 0x7b007 },
  //MacBookAir7,2
  { "MacBookAir7,2", "MBA71.88Z.0171.B00.1708072210", "Mac-937CB26E2E02BB01", // Intel Core i7-5650U @ 2.20 GHz
    "MacBook Air", "1.0", "C02Q1HACG940", "Air-Enclosure",
    { 0x02, 0x27, 0x0f, 0, 0, 0x02 },  "j113", "j113", 0x7b007 }, // need ECPI
  //Macmini1,1
  { "Macmini1,1", "MM11.88Z.0055.B08.0610121326", "Mac-F4208EC8", // Intel Core 2 Duo T7200 @ 2.00 GHz
    "Mac mini", "1.0", "W8702N1JU35", "Mini-Aluminum",
    { 0x01, 0x03, 0x0f, 0, 0, 0x04 },  "m40", "m40", 0x78002 }, // need ECPI
  //Macmini2,1
  { "Macmini2,1", "MM21.88Z.009A.B00.0706281359", "Mac-F4208EAA", // Intel Core 2 Duo T5600 @ 1.83 GHz
    "Mac mini", "1.1", "W8705W9LYL2", "Mini-Aluminum",
    { 0x01, 0x19, 0x0f, 0, 0, 0x02 },  "NA", "NA", 0x78002 }, // need rBR RPlt
  //Macmini3,1
  { "Macmini3,1", "MM31.88Z.0081.B06.0904271717", "Mac-F22C86C8", // Intel Core 2 Duo P7550 @ 2.26 GHz
    "Mac mini", "1.0", "W8905BBE19X", "Mini-Aluminum",
    { 0x01, 0x35, 0x0f, 0, 0, 0x01 },  "NA", "NA", 0x78002 }, // need rBR RPlt ECPI
  //Macmini4,1
  { "Macmini4,1", "MM41.88Z.0045.B00.1708072325", "Mac-F2208EC8", // Intel Core 2 Duo P8600 @ 2.40 GHz
    "Mac mini", "1.0", "C02FHBBEDD6H", "Mini-Aluminum",
    { 0x01, 0x65, 0x0f, 0, 0, 0x02 },  "NA", "NA", 0x78002 }, // need rBR RPlt ECPI
  //Macmini5,1
  { "Macmini5,1", "MM51.88Z.007B.B00.1708080744", "Mac-8ED6AF5B48C039E1", // Intel Core i5-2415M @ 2.30 GHz
    "Mac mini", "1.0", "C07GA041DJD0", "Mini-Aluminum",
    { 0x01, 0x30, 0x0f, 0, 0, 0x03 },  "NA", "NA", 0x7d005 }, // need rBR RPlt
  //Macmini5,2
  { "Macmini5,2", "MM51.88Z.007B.B00.1708080744", "Mac-4BC72D62AD45599E", // Intel Core i7-2620M @ 2.70 GHz
    "Mac mini", "1.0", "C07HVHACDJD1", "Mini-Aluminum",
    { 0x01, 0x75, 0x0f, 0, 0, 0x00 },  "NA", "NA", 0x7d005 }, // need rBR RPlt ECPI
  //Macmini5,3
  { "Macmini5,3", "MM51.88Z.007B.B00.1708080744", "Mac-7BA5B2794B2CDB12", // Intel Core i7-2635QM @ 2.00 GHz
    "Mac mini", "1.0", "C07GWHACDKDJ", "Mini-Aluminum",
    { 0x01, 0x77, 0x0f, 0, 0, 0x00 },  "NA", "NA", 0x7d005 }, // need rBR RPlt ECPI
  //Macmini6,1
  { "Macmini6,1", "MM61.88Z.010B.B00.1708080649", "Mac-031AEE4D24BFF0B1", // Intel Core i5-3210M @ 2.50 GHz
    "Mac mini", "1.0", "C07JNHACDY3H", "Mini-Aluminum",
    { 0x02, 0x07, 0x0f, 0, 0, 0x00 },  "NA", "NA", 0x7d006 }, // need rBR RPlt ECPI
  //Macmini6,2
  { "Macmini6,2", "MM61.88Z.010B.B00.1708080649", "Mac-F65AE981FFA204ED", // Intel Core i7-3615QM @ 2.30 GHz
  ...
  //iMac4,1
  { "iMac4,1", "IM41.88Z.0055.B08.0609061538", "Mac-F42787C8", // Intel Core 2 Duo T7200 @ 2.00 GHz
    "iMac", "1.0", "W8608HACU2P", "iMac",
    { 0x01, 0x01, 0x0f, 0, 0, 0x05 },  "m38m39", "m38", 0x73002 }, // need ECPI
  //iMac4,2
  { "iMac4,2", "IM42.88Z.0071.B03.0610121320", "Mac-F4218EC8", // Intel Core 2 Duo T5600 @ 1.83 GHz
    "iMac", "1.0", "W8627HACV2H", "iMac",
    { 0x01, 0x06, 0x0f, 0, 0, 0x00 },  "NA", "NA", 0x73002 }, // need rBR RPlt ECPI
  //iMac5,1
  { "iMac5,1", "IM51.88Z.0090.B09.0706270921", "Mac-F4228EC8", // Intel Core 2 Duo T7400 @ 2.16 GHz
    "iMac", "1.0", "CK637HACX1A", "iMac",
    { 0x01, 0x08, 0x0f, 0, 0, 0x02 },  "NA", "NA", 0x73002 }, // need rBR RPlt ECPI
  //iMac5,2
  { "iMac5,2", "IM52.88Z.0090.B09.0706270913", "Mac-F4218EC8", // Intel Core 2 Duo T5600 @ 1.83 GHz
    "iMac", "1.0", "W8716HACWH5", "iMac",
    { 0x01, 0x06, 0x0f, 0, 0, 0x00 },  "NA", "NA", 0x73002 }, // need rBR RPlt ECPI
  //iMac6,1
  { "iMac6,1", "IM61.88Z.0093.B07.0804281538", "Mac-F4218FC8", // Intel Core 2 Duo T7400 @ 2.16 GHz
    "iMac", "1.0", "W8652HACVGN", "iMac",
    { 0x01, 0x08, 0x0f, 0, 0, 0x02 },  "NA", "NA", 0x73002 }, // need rBR RPlt ECPI
  //iMac7,1
  { "iMac7,1", "IM71.88Z.007A.B03.0803051705", "Mac-F42386C8", // Intel Core 2 Extreme X7900 @ 2.80 GHz
    "iMac", "1.0", "W8803HACY51", "iMac-Aluminum",
    { 0x01, 0x20, 0x0f, 0, 0, 0x04 },  "NA", "NA", 0x73002 }, // need rBR RPlt ECPI
  //iMac8,1
  { "iMac8,1", "IM81.88Z.00C1.B00.0802091538", "Mac-F227BEC8", // Intel Core 2 Duo E8435 @ 3.06 GHz
    "iMac", "1.3", "W8755HAC2E2", "iMac-Aluminum",
    { 0x01, 0x29, 0x0f, 0, 0, 0x01 },  "k3", "k3", 0x73002 },
  //iMac9,1
  { "iMac9,1", "IM91.88Z.008D.B08.0904271717", "Mac-F2218FA9", // Intel Core 2 Duo E8135 @ 2.66 GHz
    "iMac", "1.0", "W89A00A36MJ", "iMac-Aluminum",
    { 0x01, 0x36, 0x0f, 0, 0, 0x03 },  "NA", "NA", 0x73002 }, // need rBR RPlt ECPI
  //iMac10,1
  { "iMac10,1", "IM101.88Z.00CF.B00.1708080133", "Mac-F2268CC8", // Intel Core 2 Duo E7600 @ 3.06 GHz
    "iMac", "1.0", "W80AA98A5PE", "iMac-Aluminum",
    { 0x01, 0x53, 0x0f, 0, 0, 0x13 },  "k22k23", "k23", 0x7b002 },
  //iMac11,1
  { "iMac11,1", "IM111.88Z.0037.B00.1708080241", "Mac-F2268DAE", // Intel Core i7-860 @ 2.80 GHz
    "iMac", "1.0", "G8942B1V5PJ", "iMac-Aluminum",
    { 0x01, 0x54, 0x0f, 0, 0, 0x36 },  "k23f", "k23f", 0x7b004 },
  //iMac11,2
  { "iMac11,2", "IM112.88Z.005B.B00.1708080439", "Mac-F2238AC8", // Intel Core i3-540 @ 3.06 GHz
    "iMac", "1.2", "W8034342DB7", "iMac-Aluminum",
    { 0x01, 0x64, 0x0f, 0, 0, 0x05 },  "k74", "k74", 0x7c004 },
  //iMac11,3
  { "iMac11,3", "IM112.88Z.005B.B00.1708080439", "Mac-F2238BAE", // Intel Core i5-760 @ 2.80 GHz
    "iMac", "1.0", "QP0312PBDNR", "iMac-Aluminum",
    { 0x01, 0x59, 0x0f, 0, 0, 0x02 },  "k74", "k74", 0x7d004 },
  //iMac12,1
  { "iMac12,1", "IM121.88Z.004D.B00.1708080012", "Mac-942B5BF58194151B", // Intel Core i7-2600S @ 2.80 GHz
    "iMac", "1.9", "W80CF65ADHJF", "iMac-Aluminum",
    { 0x01, 0x71, 0x0f, 0, 0, 0x22 },  "k60", "k60", 0x73005 },
  //iMac12,2
  { "iMac12,2", "IM121.88Z.004D.B00.1708080012", "Mac-942B59F58194171B", // Intel Core i5-2500S @ 2.70 GHz
  ...
  //iMac14,1
  { "iMac14,1", "IM141.88Z.0123.B00.1708211404", "Mac-031B6874CF7F642A", // Intel Core i5-4570R @ 2.70 GHz
  ...
  //MacPro2,1
  { "MacPro2,1", "MP21.88Z.007F.B06.0707021348", "Mac-F4208DA9", // Intel Xeon X5365 @ 2.99 GHz x2
    "MacPro", "1.0", "W8930518UPZ", "Pro-Enclosure",
    { 0x01, 0x15, 0x0f, 0, 0, 0x03 },  "m43a", "m43a", 0x79001 }, // need ECPI
  //MacPro3,1
  { "MacPro3,1", "MP31.88Z.006C.B05.0802291410", "Mac-F42C88C8", // Intel Xeon E5462 @ 2.80 GHz x2
    "MacPro", "1.3", "W88A77AA5J4", "Pro-Enclosure",
    { 0x01, 0x30, 0x0f, 0, 0, 0x03 },  "m86", "m86", 0x79001 },
  //MacPro4,1
  { "MacPro4,1", "MP41.88Z.0081.B07.0910130729", "Mac-F221BEC8", // Intel Xeon X5670 @ 2.93 GHz x2
  ...
  //MacPro6,1
  { "MacPro6,1", "MP61.88Z.0120.B00.1708080652", "Mac-F60DEB81FF30ACF6", // Intel Xeon E5-1650 v2 @ 3.50 GHz
    "MacPro", "1.0", "F5KLA770F9VM", "Pro-Enclosure",
    { 0x02, 0x20, 0x0f, 0, 0, 0x18 },  "j90", "j90", 0xf0f006 },
  //Xserve1,1
  { "Xserve1,1", "XS11.88Z.0080.B01.0706271533", "Mac-F4208AC8", // Intel Xeon E5345 @ 2.33 GHz x2
    "Xserve", "1.0", "CK703E1EV2Q", "Xserve",
    { 0x01, 0x11, 0x0f, 0, 0, 0x05 },  "NA", "NA", 0x79001 }, // need rBR RPlt ECPI
  //Xserve2,1
  { "Xserve2,1", "XS21.88Z.006C.B06.0804011317", "Mac-F42289C8", // Intel Xeon E5472 @ 3.00 GHz x2
    "Xserve", "1.0", "CK830DLQX8S", "Xserve",
    { 0x01, 0x26, 0x0f, 0, 0, 0x03 },  "NA", "NA", 0x79001 }, // need rBR RPlt ECPI
  //Xserve3,1
  { "Xserve3,1", "XS31.88Z.0081.B06.0908061300", "Mac-F223BEC8", // Intel Xeon E5520 @ 2.26 GHz

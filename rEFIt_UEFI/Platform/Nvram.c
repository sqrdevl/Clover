...
ResetEmuNvram ()
{
  ...
  //DeleteNvramVariable(L"prev-lang:kbd",           &gAppleBootVariableGuid);
  //DeleteNvramVariable(L"backlight-level",         &gAppleBootVariableGuid);
  //DeleteNvramVariable(L"boot-args",               &gAppleBootVariableGuid);
  //DeleteNvramVariable(L"nvda_drv",                &gAppleBootVariableGuid);
  ...
  //DeleteNvramVariable(L"boot-image-key",          &gAppleBootVariableGuid);
  //DeleteNvramVariable(L"boot-signature",          &gAppleBootVariableGuid);
  //DeleteNvramVariable(L"boot-switch-vars",        &gAppleBootVariableGuid);
...
ResetNativeNvram ()
{
  ...
  // TODO: if want to delete more nvram variables like realmac's reset NVRAM, consider it
  //Status = DeleteNvramVariable(L"prev-lang:kbd",          &gAppleBootVariableGuid);
  //Status = DeleteNvramVariable(L"backlight-level",        &gAppleBootVariableGuid);
  Status = DeleteNvramVariable(L"boot-args",              &gAppleBootVariableGuid);
  Status = DeleteNvramVariable(L"nvda_drv",               &gAppleBootVariableGuid);
  Status = DeleteNvramVariable(L"install-product-url",    &gAppleBootVariableGuid);
  Status = DeleteNvramVariable(L"previous-system-uuid",   &gAppleBootVariableGuid);
